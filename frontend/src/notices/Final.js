...
//     if (selectedId) {
//       const selectedModeration = moderations.find((moderation) => moderation.id === selectedId);
//       if (selectedModeration) {
//         const moderationInfo = `${selectedModeration.exam_year} - ${selectedModeration.sem.exam_system.year} year ${selectedModeration.sem.semester} sem`;
//         setSelectedModerationInfo(moderationInfo);
//       }
//     } else {
//       setSelectedModerationInfo('');
//     }
//   };

  return (
    <div id="pdf-content">
       <PrintComponent content={} ref={componentRef} />
...
<div className="Title">
    {/* <a href='#' className='logo-anchor'>
           ...
           <div className="img"><img src={img2}  className="img-left" alt="" /></div> 
     ...
     <p className=' text-center '>JAHANGIRNAGAR UNIVERSITY<br></br>
      ...
      {moderationReport && moderationReport.notice_question_moderation && (
        <div>
          ...
          <p> কম্পিউটার সায়েন্স এন্ড ইঞ্জিনিয়ারিং    বিভাগের
             &nbsp; {moderationReport.notice_question_moderation.date} &nbsp; তারিখ
          
          রোজ {moderationReport.notice_question_moderation.day}&nbsp; 
          সকাল {moderationReport.notice_question_moderation.time}</p>
